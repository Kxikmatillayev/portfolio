...
const End = () => {
    ...
    const sendMessageBot = (e) => {
        ...
        if (!formData.name || !phone.number) {
            setError('Please fill out all required fields: Name and Phone number.');
            return;
        }
    ...
    return (
        <>
            <section id='s3' className='dark:bg-dakr py-10 dark:text-oq'>
                <div className='container sm:hidden flex flex-row justify-center'>
                    <div className='h-[200px] w-full flex justify-center text-center items-center border-2 border-qora dark:border-oq'>
                        <h1 className='text-2xl underline'><NavLink to={"end2"}>{t("boglanish")}</NavLink></h1>
                    </div>
                </div>
                <section className='container hidden sm:flex flex-col justify-center items-center'>
                    <h1 className='text-3xl underline font-bold pb-10'>{t("boglanish")}</h1>
                    <section className='hidden sm:flex flex-col md:flex-row justify-center items-center gap-10 w-full'>
